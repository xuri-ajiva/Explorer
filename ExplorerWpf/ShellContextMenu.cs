...
namespace Peter {
    ...
    internal class ShellContextMenu : NativeWindow {
        ...
        private bool GetContextMenuInterfaces(IShellFolder oParentFolder, IntPtr[] arrPIDLs, out IntPtr ctxMenuPtr) {
            var nResult = oParentFolder.GetUIObjectOf( IntPtr.Zero,
            ...
            if ( S_OK == nResult ) {
                this._oContextMenu = (IContextMenu) Marshal.GetTypedObjectForIUnknown( ctxMenuPtr, typeof(IContextMenu) );
        ...
        protected override void WndProc(ref Message m) {
            ...
            if ( this._oContextMenu2 != null &&
                ...
                if ( this._oContextMenu2.HandleMenuMsg( (uint) m.Msg, m.WParam, m.LParam ) == S_OK )
                    return;
            ...
            if ( this._oContextMenu3 != null &&
                ...
                if ( this._oContextMenu3.HandleMenuMsg2( (uint) m.Msg, m.WParam, m.LParam, IntPtr.Zero ) == S_OK )
                    return;
        ...
        private IShellFolder GetParentFolder(string folderName) {
            if ( null == this._oParentFolder ) {
                ...
                if ( null == oDesktopFolder ) return null;
                ...
                this._oParentFolder = (IShellFolder) Marshal.GetTypedObjectForIUnknown( pUnknownParentFolder, typeof(IShellFolder) );
            }
        ...
        private void InvokeContextMenuDefault(FileInfo[] arrFI) {
            ...
            try {
                ...
                if ( false == GetContextMenuInterfaces( this._oParentFolder, this._arrPIDLs, out iContextMenuPtr ) ) {
                    ReleaseAll();
                    return;
                }
        ...
        protected IntPtr[] GetPIDLs(FileInfo[] arrFI) {
            ...
            if ( null == oParentFolder ) return null;
        ...
        private void ShowContextMenu(Point pointScreen) {
            ...
            try {
                ...
                this._oContextMenu2 = (IContextMenu2) Marshal.GetTypedObjectForIUnknown( iContextMenuPtr2, typeof(IContextMenu2) );
                this._oContextMenu3 = (IContextMenu3) Marshal.GetTypedObjectForIUnknown( iContextMenuPtr3, typeof(IContextMenu3) );

                var nSelected = TrackPopupMenuEx( pMenu,
                    TPM.RETURNCMD,
                    pointScreen.X,
                    pointScreen.Y,
                    this.Handle,
